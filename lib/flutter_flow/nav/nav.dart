      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Airquality_shots',
              path: 'airqualityShots',
              builder: (context, params) => AirqualityShotsWidget(
                airshot: params.getParam('airshot', ParamType.DocumentReference,
                    false, 'fault_list'),
              ),
            ),
            FFRoute(
              name: 'Defacts_list',
              path: 'defactsList',
              builder: (context, params) => DefactsListWidget(),
            ),
            FFRoute(
              name: 'Defacts_main',
              path: 'defactsMain',
            ...
            FFRoute(
              name: 'Defacts_shots',
              path: 'defactsShots',
              builder: (context, params) => DefactsShotsWidget(),
            ),
            FFRoute(
              name: 'DefactsDistance',
              path: 'defactsDistance',
              builder: (context, params) => DefactsDistanceWidget(),
            ),
            FFRoute(
